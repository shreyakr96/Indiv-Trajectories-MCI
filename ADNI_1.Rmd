...
M_Hippocampus_icv = mean(MCI$Hippocampus_icv)
SD_Hippocampus_icv = sd(MCI$Hippocampus_icv)

M_MCI$Entorhinal_icv = mean(MCI$Entorhinal_icv)
S_MCI$Entorhinal_icv = sd(MCI$Entorhinal_icv)

M_Fusiform_icv = mean(MCI$Fusiform_icv)
SD_Fusiform_icv = SD(MCI$Fusiform_icv)

M_MCI$Occipital_icv = mean(MCI$Occipital_icv)
SD_MCI$Occipital_icv = sd(MCI$Occipital_icv)

M_MCI$Ventricles_icv = mean(MCI$Ventricles_icv)
SD_MCI$Ventricles_icv = sd(MCI$Ventricles_icv)

M_MCI$WholeBrain_icv = mean(MCI$WholeBrain_icv)
SD_MCI$WholeBrain_icv = sd(MCI$WholeBrain_icv)
